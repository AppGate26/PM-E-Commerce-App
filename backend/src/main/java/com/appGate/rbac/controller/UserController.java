...
public class UserController {
    ...
    public BaseResponse signIn(@Valid @RequestBody LoginRequest signInRequest, HttpServletRequest request) {
        return userService.signIn(signInRequest, resolveClientIp(request), request.getHeader("User-Agent"));
    }

    /** Returns the originating client IP, honouring the proxy header set by Vercel/load balancers. */
