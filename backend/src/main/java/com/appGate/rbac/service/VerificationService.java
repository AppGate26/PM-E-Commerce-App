...
public class VerificationService {
    ...
    private Profile saveProfile(PersonalInformationDto personalInformationDto, User user, String baseUrl) {
        ...
        UtilityBill utilityBillSaved = saveOrUpdateUtilityBill(user, personalInformationDto, baseUrl);
    ...
    private UtilityBill saveOrUpdateUtilityBill(User user, PersonalInformationDto personalInformationDto, String baseUrl) {
        // Skip if no utility bill file provided
        if (personalInformationDto.getUtilityBillPicture() == null) {
            return null;
        }

        try {
            UtilityBill existingUtilityBill = utilityBillRepository.findByUserId(user.getId());
            ...
            if (existingUtilityBill == null) {
                ...
                utilityBill = existingUtilityBill;
            }

            String savedImagePath = saveImage(personalInformationDto.getUtilityBillPicture(), "utilityBill", baseUrl);
            if (savedImagePath != null) {
                utilityBill.setUtilityBillPicture(savedImagePath);
            }
            if (personalInformationDto.getUtilityBillType() != null) {
                utilityBill.setUtilityBill(personalInformationDto.getUtilityBillType());
            }
            return utilityBillRepository.save(utilityBill);
        } catch (DataIntegrityViolationException e) {
            UtilityBill utilityBill = utilityBillRepository.findByUserId(user.getId());
            if (utilityBill == null) {
                throw new RuntimeException("Failed to resolve utility bill after concurrent insert");
            }
            String savedImagePath = saveImage(personalInformationDto.getUtilityBillPicture(), "utilityBill", baseUrl);
            if (savedImagePath != null) {
                utilityBill.setUtilityBillPicture(savedImagePath);
