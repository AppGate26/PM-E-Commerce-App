...
public class Customer extends BaseEntity implements com.appGate.rbac.context.BranchOwned {

    /** The branch that registered this customer. */
    ...
    // A newly registered walk-in customer stays pending until an admin approves the
    // registration (CUSTOMER_REGISTRATION approval).
    ...
    private java.time.LocalDate loanDueDate;
}
