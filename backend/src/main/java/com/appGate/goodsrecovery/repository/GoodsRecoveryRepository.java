...
public interface GoodsRecoveryRepository extends JpaRepository<GoodsRecovery, Long> {
    ...
    java.util.List<GoodsRecovery> findByBranchId(Long branchId);
    Page<GoodsRecovery> findByBranchId(Long branchId, Pageable pageable);
    Page<GoodsRecovery> findByStatusAndBranchId(GoodsRecoveryStatus status, Long branchId, Pageable pageable);
}
