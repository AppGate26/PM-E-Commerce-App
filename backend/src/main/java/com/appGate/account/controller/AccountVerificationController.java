...
public class AccountVerificationController {
    ...
    @GetMapping("/user/{userId}/is-verified")
    public BaseResponse isUserVerified(@PathVariable Long userId) {
        return verificationService.isUserVerified(userId);
    }
    ...
    @GetMapping("/center/users")
    public BaseResponse getVerificationCenterUsers() {
        return verificationService.getVerificationCenterUsers();
    }
}
