...
public class AccountController {
    ...
    @Operation(summary = "Get accounts by type", description = "Filter accounts by Account Type ID")
    @GetMapping("/type/{accountTypeId}")
    public BaseResponse getAccountsByType(@PathVariable Long accountTypeId) {
        return accountService.getAccountsByType(accountTypeId);
    }
