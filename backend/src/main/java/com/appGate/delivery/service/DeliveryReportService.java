...
public class DeliveryReportService {
    ...
    /** Load a rider, refusing one that belongs to another branch. */
    private Rider riderInScope(Long riderId) {
    ...
    public BaseResponse getRiderBoxReport(Long riderId, int page, int size) {
        Rider rider = riderInScope(riderId);
    ...
    public BaseResponse getRiderInfoReport(int page, int size) {
        ...
        Page<Rider> riders = branchId == null
                ? riderRepository.findAll(pageable)
                : riderRepository.findByBranchId(branchId, pageable);
    ...
    public BaseResponse getDeliveriesReport(int page, int size) {
        Long branchId = branchScopeService.getScopedBranchId();
        List<Order> deliveredOrders = branchId == null
                ? orderRepository.findByDeliveryStatus(DeliveryStatus.DELIVERED)
                : orderRepository.findByBranchIdAndDeliveryStatus(branchId, DeliveryStatus.DELIVERED);
