...
public class DeliveryNotification extends BaseEntity implements com.appGate.rbac.context.BranchOwned {

    /** The branch that owns the delivery this notification is about. */
