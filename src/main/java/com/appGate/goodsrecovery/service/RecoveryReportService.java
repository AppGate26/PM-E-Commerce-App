...
public class RecoveryReportService {
    ...
    public BaseResponse getRecoveryReport() {
        List<GoodsRecovery> allRecoveries = goodsRecoveryRepository.findAll();
        List<RecoveryBox> allBoxes = recoveryBoxRepository.findAll();
    ...
    public BaseResponse getLoanReport() {
        List<LoanNotification> allNotifications = loanNotificationRepository.findAll();
    ...
    public BaseResponse getLoanReportByCustomer(Long customerId) {
        List<LoanNotification> customerNotifications = loanNotificationRepository.findByCustomerIdOrderByNotificationDateDesc(customerId);
