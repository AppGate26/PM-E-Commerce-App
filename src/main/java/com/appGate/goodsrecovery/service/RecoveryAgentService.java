...
public class RecoveryAgentService {
    ...
    public BaseResponse getAllRecoveryAgents() {
        return new BaseResponse(HttpStatus.OK.value(), "successful", recoveryAgentRepository.findAll());
    }
    ...
    public BaseResponse getSuspendedRecoveryAgents() {
        return new BaseResponse(HttpStatus.OK.value(), "successful", recoveryAgentRepository.findBySuspended(true));
    }
    ...
    private RecoveryAgent getRecoveryAgent(Long id) {
        return recoveryAgentRepository.findById(id)
