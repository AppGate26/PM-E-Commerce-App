...
public class ApprovalController {
    ...
    public BaseResponse approveRequest(@PathVariable Long id, @Valid @RequestBody ApprovalActionDto dto) {
        return approvalService.approveRequest(id, dto);
    }

    @Operation(summary = "Decline request", description = "Decline a pending approval request with reason")
    @PatchMapping("/{id}/decline")
    public BaseResponse declineRequest(@PathVariable Long id, @Valid @RequestBody ApprovalActionDto dto) {
        return approvalService.declineRequest(id, dto);
    }
