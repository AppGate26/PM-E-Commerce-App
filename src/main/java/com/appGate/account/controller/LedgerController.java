...
public class LedgerController {
    ...
    @Operation(summary = "Get account ledger", description = "Retrieve ledger for a specific account")
    ...
    @Operation(summary = "Get customer ledger", description = "Retrieve ledger for a specific customer")
