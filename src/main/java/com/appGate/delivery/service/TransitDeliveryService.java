...
public class TransitDeliveryService {
    ...
    public BaseResponse markAsDelivered(Long orderId) {
        ...
        if (order.getDeliveryStatus() != DeliveryStatus.IN_TRANSIT && order.getDeliveryStatus() != DeliveryStatus.IN_TRANSIT) {
        ...
        return new BaseResponse(HttpStatus.OK.value(), "Order marked as delivered successfully", order);
    }
