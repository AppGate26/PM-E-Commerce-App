...
const ReuseableChartNav = ({ title = "Title" }) => {
  return (
    <div>
      <nav className="bg-primary d-flex align-items-center justify-content-between px-5 py-3">
        ...
        <h2 className="text-white text-uppercase fw-semibold text-nav-chart-h2">
          chart of account <span className="mx-5 " style={{fontSize:"38px", fontWeight:"200"}}>|</span>{title}
        </h2>
        <Link to="/">
...
export default ReuseableChartNav;
