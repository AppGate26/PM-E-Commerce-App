...
export const NIGERIA_LGAS_BY_STATE = {
  ...
  Oyo: ["Afijio", "Akinyele", "Atiba", "Atisbo", "Egbeda", "Ibadan North", "Ibadan North-East", "Ibadan North-West", "Ibadan South-East", "Ibadan South-West", "Ibarapa Central", "Ibarapa East", "Ibarapa North", "Ido", "Ifedapo", "Ifeloju", "Irepo", "Iseyin", "Itesiwaju", "Iwajowa", "Kajola", "Lagelu", "Ogbomosho North", "Ogbomosho South", "Ogo Oluwa", "Olorunsogo", "Oluyole", "Ona Ara", "Orelope", "Ori Ire", "Oyo", "Oyo East", "Saki East", "Saki West", "Surulere"],
...
export const NIGERIA_STATES = Object.keys(NIGERIA_LGAS_BY_STATE);

export const isNigeriaCountry = (value = "") => {
  const normalized = value.trim().toLowerCase();
  return normalized === "nigeria" || normalized === "nigerian";
};

export const getNigeriaLgas = (state = "") => {
  const match = NIGERIA_STATES.find(
    (item) => item.toLowerCase() === state.trim().toLowerCase()
  );
  return match ? NIGERIA_LGAS_BY_STATE[match] : [];
};
